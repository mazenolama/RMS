...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Discount Management</h1>
                        ...
                        <div class="card-header py-3">
                        	<div class="row">
                            	...
                            	<div class="col" align="right">
                            		<button type="button" name="add_discount" id="add_discount" class="btn btn-success btn-circle btn-sm"><i class="fas fa-plus"></i></button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="discount_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Discount Name</th>
        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
		          		...
		          		<input type="text" name="discount_name" id="discount_name" class="form-control" required data-parsley-pattern="/^[a-zA-Z0-9 \s]+$/" data-parsley-trigger="keyup" />
		          	</div>
                    <div class="form-group">
...
$(document).ready(function(){
	...
	var dataTable = $('#discount_table').DataTable({
		"processing" : true,
		"serverSide" : true,
		"order" : [],
		"ajax" : {
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	data:{discount_id:discount_id, action:'fetch_single'},
